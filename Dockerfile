...
RUN go build -o svc-cpu svc-cpu.go
RUN go build -o svc-io svc-io.go
RUN go build -o svc-mem svc-mem.go
RUN go build -o svc-chain svc-chain.go
RUN go build -o svc-fanout svc-fanout.go
